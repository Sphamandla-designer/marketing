...
export const FORMS = {
  register: {
    ...
    attendance: {
      ...
      notes: [
        ...
        'Indicate ABSENT (A) or LATE (L) only. If all learners are present, leave the table blank.',
      ],
      defaultRows: 10,
      maxRows: 60,
      extraRowsNoteLabel: 'Additional learners (if more than 10)',
    },
    observations: {
      letter: 'B',
      ...
      notes: [
        'Use the learner’s position number from the class list (learner names are on a separate reference list).',
        'Record a single observation code (one character) for each learner and day. If no observation, leave the cell blank.',
      ],
      /** 'combined' = one wide cell per day holding learner no. + code. */
      mode: 'combined',
      defaultRows: 10,
      maxRows: 60,
    },
  ...
  subject: {
    ...
    attendance: {
      ...
      defaultRows: 6,
      maxRows: 60,
      extraRowsNoteLabel: 'Additional learners (if more than 6)',
    },
    observations: {
      letter: 'B',
      title: 'NOTABLE LEARNER OBSERVATIONS',
